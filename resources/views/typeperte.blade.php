        ...
        <section class="section dashboard">
            <div class="row">
                            ...
                            <div class="card top-selling overflow-auto">
                                <div class="card-body pb-0">
                                    ...
                                    <h5 class="card-title"><button class="btn btn-"
                                            ...
                                            class="bi bi-plus"></i>Nouveau type de perte</button></h5>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="modal fade modal-md" id="basicModal" tabindex="-1">
                                <div class="modal-dialog ">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <!-- Multi Columns Form -->
                                            <form class="row g-3" action="{{route('type_perte_store')}}" method="POST"
                                                enctype="multipart/form-data">
                                                @csrf
                                                <div class="col-md-8">
                                                    <label for="inputName5" class="form-label">Type de perte</label>
                                                    <input type="text" class="form-control" id="inputName5"
                                                        placeholder="type de perte" name="nameType" required>
                                                </div>
