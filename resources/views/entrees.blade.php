                        ...
                        <div class="col-12">
                            <div class="card top-selling overflow-auto">
                                <div class="card-body pb-0">
                                    <h5 class="card-title">Historique des entrees du stock</h5>
                                    <h5 class="card-title"><a href="{{route('entreeListExport')}}"><button class="btn btn-" style="background: #390101;color:white;"><i class="bi bi-file-earmark-pdf"></i>Telecharger</button></a></h5>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-3">
                                        <p class="text-black float-end fw-bold" style="background: #390101;padding:6px;"><span class="text-white me-3">
                                            Valeur des entrees :</span><span
                                            style="font-size: 15px;color:#ffffff;">{{ number_format($total,2) }}
                                            Fbu</span></p>
                                    </div>
                                </div>
                            </div>
