                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="row">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                              <h5 class="card-title" style="color: #390101;">Modifier le nom du produit</h5>
                                          ...
                                          @endif
                                              ...
                                              <!-- Multi Columns Form -->
                                              <form class="row g-3" action="{{route('produit_update',$article->id)}}" method="POST" enctype="multipart/form-data">
                                                @csrf

                                                <div class="col-md-8">
                                                  <label for="inputName5" class="form-label">Nom du produit</label>
                                                  <input type="text" class="form-control" id="inputName5" value="{{$article->nameProduct}}" name="nameProduct" required>
                                                </div>
                                                <div class="col-md-8">
                                                  <label for="inputName5" class="form-label">Prix d'Achat</label>
                                                  <input type="number" class="form-control" id="inputName5" value="{{$article->wholeSalePrice}}" name="wholeSalePrice" required>
                                                </div>
                                                <div class="col-md-8">
                                                  <label for="inputName5" class="form-label">Discount</label>
                                                  <input type="number" class="form-control" id="inputName5" value="{{$article->discount}}" name="discount">
                                                </div>
