                        ...
                        <div class="col-12">
                            <div class="card top-selling overflow-auto">
                                <div class="card-body pb-0">
                                    <h5 class="card-title">Liste des offres familiales</h5>
                                    <a href="{{ route('offreList') }}"><button
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($product as $products)
                                                <tr>
                                                    ...
                                                    <td><a href="{{ route('billOfferFmily', $products->numeroSorti) }}"><i
                                                        class="bi bi-eye text-primary"></i></a></td>
                                                        <td><a href="{{ route('returnStockOffer', $products->id) }}" onclick="return confirm('Voulez-vous enlever cet offre ?')"><i
                                                        class="bi bi-trash text-primary"></i></a></td>
                                                    @php
                                ...
                                <div class="row">
                                    <div class="col-xl-3">
                                        <p class="text-black float-end fw-bold" style="background: #390101;padding:6px;color:#ffffff;"><span class="text-white me-3" style="font-size: 10px;">
                                                Capital :</span><span
                                                style="font-size: 12px;color:#ffffff;">0
                                                {{-- {{number_format($achat, 0, ',', '.')}} --}}
                                                Fbu</span></p>
                                    </div>
                                    <div class="col-xl-3">
                                        <p class="text-black float-end fw-bold" style="background: #390101;padding:6px;color:#ffffff;"><span class="text-white me-3" style="font-size: 10px;">
