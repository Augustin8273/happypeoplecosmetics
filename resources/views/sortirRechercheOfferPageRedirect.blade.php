                        ...
                        <div class="col-12">
                            <div class="card top-selling overflow-auto">
                                <div class="card-body pb-0">
                                    <h5 class="card-title"><span style="color: red;font-weight:bold;font-size:25px;">Offre familiale</span> : <span style="color: green;font-weight:bold;font-size:25px;">{{$product->Produitname->nameProduct}}</span></h5>
                                    ...
                                    <table class="table table-bordeless datatable" id="example">
                                        ...
                                        <tbody>
                                            ...
                                            <form method="POST"name="myform" action="{{route('productRechercheOfferSortirStore',$product->product_Article_id)}}" enctype="multipart/form-data">
                                                @csrf
                                                <tr>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-6">
                                        <input type="submit" class="btn btn-success" value="Passer Offre">
