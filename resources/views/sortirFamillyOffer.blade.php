                        ...
                        <div class="col-12">
                            <div class="card top-selling overflow-auto">
                                <div class="card-body pb-0">
                                    <h5 class="card-title"><span style="color: red;font-weight:bold;font-size:25px;">Offre familiale</span></h5>
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($product as $products)
                                                <tr>
                                                    ...
                                                    <td><a href="{{ route('stockListSortirOfferRedirectPage', $products->product_Article_id) }}" class="btn btn-success">Offrir</a></td>
