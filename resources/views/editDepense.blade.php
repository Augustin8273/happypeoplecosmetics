                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="row">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                              <h5 class="card-title" style="color: #390101;">Modifier la depense</h5>
                                          ...
                                          @endif
                                              ...
                                              <!-- Multi Columns Form -->
                                              <form class="row g-3" action="{{route('depenseUpdate',$depense->id)}}" method="POST" enctype="multipart/form-data">
                                                @csrf

                                                <div class="col-md-12">
                                                  <label for="inputName5" class="form-label">Quantite</label>
                                                  <input type="number" class="form-control" id="inputName5" value="{{$depense->amount}}" min="1" name="quantite" required>
                                                </div>
                                                <div class="col-md-12">
                                                  <label for="inputName5" class="form-label">Destination</label>
                                                  <input type="text" class="form-control" id="inputName5" value="{{$depense->Destination}}" name="Destination" min="1" required>
                                                </div>
                                                <div class="col-md-12">
                                                  <label for="inputName5" class="form-label">Discount</label>
                                                  <input type="text" class="form-control" id="inputName5" value="{{$depense->Description}}" min="1" name="Description">
                                                </div>
