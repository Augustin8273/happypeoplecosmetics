...
<head>
    ...
    <title>Facture-Offer-family-Happy-Peope-Cosmetics-No-{{str_pad($bill->numeroSorti , 4, '0', STR_PAD_LEFT)}}</title>
                            ...
                            <div class="card-body">
                                <div class="container mb-5 mt-3">
                                    <div class="row d-flex align-items-baseline">
                                        <div class="col-xl-9">
                                            <p style="color: black;font-size: 20px;">Offre familiale <strong>N&#176;: #
                                    ...
                                    <div class="container">
                                        ...
                                        <div class="row">
                                            <div class="col-xl-12 d-flex justify-content-between" id="logo">
                                                <div class="">
                                                    <ul class="list-unstyled">
                                                        <li class="fw-bold">Offre effectue par : </li>
