                            ...
                            <div class="card top-selling overflow-auto">
                                <div class="card-body pb-0">
                                    ...
                                    <h5 class="card-title"><button class="btn btn-"
                                            ...
                                            class="bi bi-plus"></i>Nouvelle perte</button></h5>
                                    <table class="table datatable" id="example" >
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$articles->Produitname->nameProduct}}</td>
                                                <td>{{$articles->quantity}}</td>
                                                <td>{{$articles->unitPrice}}</td>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form class="row g-3" action="{{route('perte_store')}}" method="POST"
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <select class="form-control" name="nameProduct" required >
                                                        @foreach ($ProduitStock as $ProduitStock)
                                                        <option value="{{$ProduitStock->product_Article_id}}">{{$ProduitStock->Produitname->nameProduct}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="col-md-4">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <select class="form-control" name="typeperte" required >
                                                        @foreach ($typeperte as $typeperte)
                                                        <option value="{{$typeperte->id}}">{{$typeperte->name}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="col-md-4">
