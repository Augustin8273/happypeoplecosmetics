                        ...
                        <div class="col-lg-12">
                            <div class="row">
                                ...
                                <div class="card top-selling overflow-auto">
                                    <div class="card-body">
                                        <h5 class="card-title">Modifier stock</h5>
                                        ...
                                        <!-- Multi Columns Form -->
                                        <form class="row g-3" name="myform" action="{{ route('stockUpdate',$ProduitStock->id) }}"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-md-12">
                                                                ...
                                                                <select class="form-control" id=""
                                                                    name="article_id">
                                                                    <option value="{{$ProduitStock->Produitname->id}}">{{$ProduitStock->Produitname->nameProduct}}</option>
                                                                    @foreach ($article as $articles)
                                                                        <option value="{{ $articles->id }}">
                                                                            {{ $articles->nameProduct }}</option>
                                                                    @endforeach
                                                        ...
                                                        <td>
                                                            <div class="col-md-12">
                                                                ...
                                                                <select class="form-control" id=""
                                                                    name="category">
                                                                    <option value="{{$ProduitStock->Category->id}}">{{$ProduitStock->Category->nameCategory}}</option>
                                                                    @foreach ($category as $categories)
                                                                        <option value="{{ $categories->id }}">
                                                                            {{ $categories->nameCategory }}</option>
                                                                    @endforeach
                                                        ...
                                                        <td>
                                                            <div class="col-md-12">
                                                                ...
                                                                <input type="number" class="form-control"
                                                                    id="inputName5" min="1"
                                                                    value="{{$ProduitStock->quantity}}" name="quantite" required>
                                                        ...
                                                        <td>
                                                            <div class="col-md-12">
                                                                ...
                                                                <input type="number" class="form-control"
                                                                    id="inputName5" min="1"
                                                                    value="{{$ProduitStock->unitPrice}}" name="prixUnitaire" required>
