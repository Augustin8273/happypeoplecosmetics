                        ...
                        <div class="col-8">
                            <div class="card top-selling overflow-auto">
                                <div class="card-body pb-0">
                                    ...
                                    @endif
                                    @if (session('updateProductArticle'))
                                        <div class="alert alert-success alert-dismissible fade show" role="alert">
                                            {{ session('updateProductArticle') }}
                                            <button type="button" class="btn-close" data-bs-dismiss="alert"
                                                aria-label="Close"></button>
                                        </div>
                                    @endif
                                    ...
                                    <h5 class="card-title"><button class="btn btn-"
                                            ...
                                            <a href="{{route('kurangura_pdf')}}"><button class="btn btn-" style="background:#390101;color:white;">
                                                <i class="bi bi-file-earmark-pdf"></i>Telecharger</button></a>&nbsp&nbsp
                                            <a href="{{route('futa')}}" onclick="return confirm('Ushaka gufuta ibiri kurupapuro rwo kurangura ?')"><button class="btn btn-" style="background:#390101;color:white;">
                                                <i class="bi bi-trash"></i>Supprimer</button></a></h5>
                                    <table class="table datatable" id="example" >
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>{{$i++}}</td>
                                                <td><span style="font-weight: bold;">{{$articles->nameProduct}}</span></td>
                                                <td>{{$articles->quantite}}</td>
                                                <td>{{$articles->description}}</td>
                                                <td>
                                                    <a href="{{route('guhinduraKimwe',$articles->id)}}" style="color:#390101;"><i class="bi bi-pencil-square"></i></a>
                                                    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                                                    <a href="{{route('gufutaKimwe',$articles->id)}}" style="color:#390101;"
                                                        onclick="return confirm('Ushaka gukura kuri liste iki kirangugwa ?')"><i class="bi bi-trash"></i></a>
                                                </td>
                                            </tr>
                                            @endforeach
                                ...
                                <div class="modal-dialog ">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" style="color:#390101;">Ajout du nouveau produit
                                            </h5>
                                        ...
                                        <div class="modal-body">
                                            <!-- Multi Columns Form -->
                                            <form class="row g-3" action="{{route('ranguraStore')}}" method="POST"
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="text" class="form-control" id="inputName5"
                                                        placeholder="Nom du produit" name="nameProduct" required>
                                                </div>
                                                <div class="col-md-4">
