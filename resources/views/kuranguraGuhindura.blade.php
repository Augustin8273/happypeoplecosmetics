                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="row">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                              <h5 class="card-title" style="color: #390101;">Modifier le nom du produit a acheter</h5>
                                          ...
                                          @endif
                                              ...
                                              <!-- Multi Columns Form -->
                                              <form class="row g-3" action="{{route('guhindura',$article->id)}}" method="POST" enctype="multipart/form-data">
                                                @csrf
                                                ...
                                                <div class="col-md-8">
                                                  ...
                                                  <input type="number" class="form-control" id="inputName5" value="{{$article->quantite}}" name="quantite" required>
                                                </div>
                                                <div class="col-md-8">
                                                  <label for="inputName5" class="form-label">Description</label>
                                                  <input type="text" class="form-control" id="inputName5" value="{{$article->description}}" name="description">
                                                </div>
